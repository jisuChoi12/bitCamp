...
//BoardFunction클래스 static메소드
public class BoardFunction {
	
	public static void register(Connection conn, BufferedReader br) throws SQLException,IOException {
	...
	public static void search(Connection conn, BufferedReader br) throws SQLException,IOException {
	...
	public static void delete(Connection conn, BufferedReader br) throws SQLException,IOException {
	...
	public static void update(Connection conn, BufferedReader br) throws SQLException,IOException {
