...
public class HaksaFunction {
	...
	public void register(BufferedReader br, Connection conn, int protocol) {
		try {
			// 등록
	...
	public void list(BufferedReader br, Connection conn, int protocol) {
		try {
			// 전체출력
	...
	public void search(BufferedReader br, Connection conn, int protocol) {
		try {
			// 찾기
	...
	public void delete(BufferedReader br, Connection conn, int protocol) {
		try {
			// 삭제
	...
	public void update(BufferedReader br, Connection conn, int protocol) {
		try {
			// 수정
