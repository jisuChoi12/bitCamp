...
public class HaksaFunction {
	...
	public static void register(Scanner input, ArrayList<HashMap<String, String>> haksaList, int protocol) {
		if(protocol==1) {
...
//			}
	...
	public static void list(ArrayList<HashMap<String, String>> haksaList) {//전체출력
